...
{
    public sealed record CherryMoonlightChangelog
    {
        ...
        public CherryMoonlightChangelog(Version currentModpackVersion, IReadOnlyList<PackwizEntry> before, IReadOnlyList<PackwizEntry> after)
        {
            Before = before;
            After = after;
